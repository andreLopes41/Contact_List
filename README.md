...
<br />
 Tela de listagem de pessoas cadastradas no sistema. Apresenta os principais dados de cada pessoa, como nome e Cpf, além de permitir a edição ou exclusão de cada registro.
...
<br />
Tela para cadastrar novos contatos para uma pessoa já existente no sistema. É possível adicionar informações como tipo e descrição.
...
<br />
Tela de listagem dos contatos cadastrados para uma pessoa específica. Permite visualizar e editar as informações de cada contato.
...
<br />
Tela de edição de informações de um contato já cadastrado para uma pessoa. Permite atualizar informações como tipo e descrição.
...
<br />
Confirmação da exclusão de um contato específico, identificado pela sua chave primária (#ID == 1).
...
<br />
Confirmação da exclusão de uma pessoa específica, identificada pela sua chave primária (#ID == 1), e todos os seus contatos cadastrados no sistema.
...
<br />
Barra de Busca do sistema. Permite realizar pesquisas por nome, retornando os resultados correspondentes.
